...
async def test_voice_agent_build_tools_offline_file_drafting():
    ...
    # 2. Approve and execute project tool call
    ...
    # Verify files created physically on disk
    expected_draft_dir = os.path.abspath(f"C:\\Users\\saisr\\Projects\\SANA-LiveKit\\drafts\\test_voice_analytics_dashboard")
